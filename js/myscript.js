...
function handleFileSelect(evt) {
  	...
  	// event.target =  documet.getElementById('file')
    var canvasWidth = 500;
    ...
    // Contains the data as a URL representaing the files's data as a base64 encoded string.
    // This line triggers the loading of the file
    // contents of the file is sotres in reader.result
